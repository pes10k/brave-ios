...
extension Strings {
  ...
  public static let persistentPrivateBrowsingAlertTitle = NSLocalizedString("PersistentPrivateBrowsingAlertTitle", tableName: "BraveShared", bundle: .module, value: "Persistent Private Browsing", comment: "Persistent private browsing alert title to existing users")
  public static let persistentPrivateBrowsingAlertMessage = NSLocalizedString("PersistentPrivateBrowsingAlertMessage", tableName: "BraveShared", bundle: .module, value: "Enabling persistent private browsing will persist all your private tabs", comment: "Persistent private browsing alert message to existing users")
